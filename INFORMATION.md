...
This guide (INFORMATION.md) teaches the platform first (so every feature later in the procedure
...
```
wanderbricks/
├── INFORMATION.md            ← you are here (platform tour & procedure)
...
endpoint (INFORMATION.md Part 1, step 10) — the endpoint config is added once the first
